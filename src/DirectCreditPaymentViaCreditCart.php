...
/**
 * Class \Sunnysideup\PaymentDirectcredit\DirectCreditPaymentViaCreditCart
 */
class DirectCreditPaymentViaCreditCart extends EcommercePayment
{
    private static $table_name = 'DirectCreditPaymentViaCreditCart';
    ...
    {
        return FieldList::create(LiteralField::create($this->ClassName . '_BeforeMessage', '<div id="' . $this->ClassName . '_BeforeMessage">' . Config::inst()->get(DirectCreditPaymentViaCreditCart::class, 'before_payment_message') . '</div>'), HiddenField::create($this->ClassName, $this->ClassName, 0));
    }
